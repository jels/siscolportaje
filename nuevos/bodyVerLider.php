    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="bodyverlider.php"><i class="fa fa-circle-o"></i> Lider</a></li>
            <li class="active"><a href="bodyverCampana.php"><i class="fa fa-circle-o"></i> Campaña</a></li>
            <li class="active"><a href="bodyverLibro.php"><i class="fa fa-circle-o"></i> Libro</a></li>
          </ul>
        </li>
      </ul>
    </section>
        ...
        <div class="col-md-10">
                  <div class="nav-tabs-custom">
                    ...
                    <ul class="nav nav-tabs">
                      <li class="active"><a href="#settings" data-toggle="tab" aria-expanded="true">Libro</a></li>
                    </ul>
