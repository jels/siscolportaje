                      ...
                      <div class="tab-pane active" id="settings">
                        <form class="form-horizontal">
                          ...
                          <div class="form-group">
                            <label for="inputName" class="col-sm-2 control-label">Tipo de Campaña</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="inputName" placeholder="Tipo de campaña">
                            </div>
                          </div>

                          <div class="form-group">
                            <label for="inputName" class="col-sm-2 control-label">Fecha Inicio</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="inputName" placeholder="Fecha Inicio">
                            </div>
                          </div>

                          <div class="form-group">
                            <label for="inputName" class="col-sm-2 control-label">Fecha Fin</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="inputName" placeholder="Fecha Fin">
                            </div>
                          </div>

                          <div class="form-group">
                            <label for="inputName" class="col-sm-2 control-label">Gestión</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="inputName" placeholder="Gestión">
                            </div>
                          </div>
