...
<li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              <li class="user-header">
                ...
                <p>
                  Nombre Usuario - Colportor                                                               <!-- NOMBRE DE USUARIO y cargo -->
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="bodyregistrocolportor.php"><i class="fa fa-circle-o"></i> Registrar</a></li>
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="bodyregistrolider.php"><i class="fa fa-circle-o"></i> Registrar</a></li>
          <!--  <li><a href="index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>-->
          </ul>

          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Pagos</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
